...
public class DashboardTest extends BasePage {
    ...
    public void TC_01_VerifyDashboardPageTitle() throws InterruptedException {
        ...
        loginPage.enterUserNameText("Rebonto");
        loginPage.enterPasswordText("rules@123");
    ...
    public void TC_02_VerifyLoggedInUserName() throws InterruptedException {
        System.out.println("TC_02_VerifyLoggedInUserName is called...");

        loginPage.enterUserNameText("Rebonto");
        loginPage.enterPasswordText("rules@123");
        loginPage.clickOnLogInButton();
        String actualLoggedInUser = dashboardPage.getLoggedInUserName();
        System.out.println(actualLoggedInUser);
        Assert.assertEquals(actualLoggedInUser,"Rebonto");
    }
}
