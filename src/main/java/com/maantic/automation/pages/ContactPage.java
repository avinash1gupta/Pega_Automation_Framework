...
public class ContactPage {
    ...
    private By email_content = By.xpath("//span[contains(text(),'gopal.sutradhar@maantic.com')]");
    ...
    public boolean isNewContactCreatedSuccessfully(){
        CommonUtils.waitForVisibilityOfElement(email_content);
        return CommonUtils.isElementPresent(email_content);
    }
